...
namespace UnitTesting
{
    ...
    public class AuthAdminTest
    {
        ...
        public AuthAdminTest(TestHost testHost)
        {
        ...
        public async void TestWithoutJwtToken()
        {
            ...
            // act
            var result = (OkObjectResult) await _function.AuthForAdmin(req, loggerMock.Object);
        ...
        [Fact]
        public async void TestWithValidToken_NotAdmin()
        {
            var req = new DefaultHttpContext().Request;
